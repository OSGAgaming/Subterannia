...
{
    public class FirstPersonCamera : CameraTransform
    {
        public ModEntity FocalEntity { get; set; }
        ...
        public FirstPersonCamera(
            ModEntity entity, Vector3 cameraDirection, float fieldOfView = MathHelper.PiOver4,
